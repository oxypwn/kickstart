...
d-i netcfg/get_ipaddress string 192.168.2.16
...
d-i passwd/user-fullname string Nagios Admin
d-i passwd/username string nagios
# Normal user's password, either in clear text
d-i passwd/user-password password nagios
d-i passwd/user-password-again password nagios
# or encrypted using an MD5 hash.
...
d-i pkgsel/include string openssh-server build-essential nagios3 php5 php5-mysql mysql-sever
